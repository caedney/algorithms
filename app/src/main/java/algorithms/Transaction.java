...
public class Transaction implements Comparable<Transaction> {
     ...
     * @throws IllegalArgumentException if {@code amount} is {@code Double.NaN},
     ...
     * @return { a negative integer, zero, a positive integer}, depending on whether
     *         the amount of this transaction is { less than, equal to, or greater
     *         than } the amount of that transaction
     */
