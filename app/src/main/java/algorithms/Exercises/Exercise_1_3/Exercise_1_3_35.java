 ...
 * last position (index {@code N-1}). Then delete and return the last ob-ject,
 * as in {@code ResizingArrayStack}. Write a client that deals bridge hands (13
