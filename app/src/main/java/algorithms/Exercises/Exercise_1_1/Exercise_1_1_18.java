...
public class Exercise_1_1_18 {
    ...
    public static void main(String[] args) {
        int multiply_result = multiply(2, 25);
        // mystery(2, 25)
        // mystery(4, 12) + 2
        // mystery(8, 6);
        // mystery(16, 3);
        ...
        // mystery(64, 0) + 32
        // 0
        StdOut.println(multiply_result); // 50
        multiply_result = multiply(3, 11);
        // mystery(3, 11);
        // mystery(6, 5) + 3
        // mystery(12, 2) + 6
        // mystery(24, 1)
        // mystery(48, 0) + 24
        // 0
        StdOut.println(multiply_result); // 33

        int power_result = power(2, 25);
        // mystery_alt(2, 25)
        // mystery_alt(4, 12) * 2
        // mystery_alt(16, 6)
        // mystery_alt(256, 3)
        ...
        // 1
        StdOut.println(power_result); // 33554432
        power_result = power(3, 11);
        // mystery_alt(3, 11)
        // mystery_alt(9, 5) * 3
        // mystery_alt(81, 2) * 9
        // mystery_alt(6561, 1)
        ...
        // 1
        StdOut.println(power_result); // 177147
    }
}
